      ...
      <div class="col-12 col-md-5" id="showData">
        <table class="table table-striped">
          ...
          // Check connection
            ...
            $sql = "SELECT book_Id_code, book_title,book_loan_status, author FROM Books ";
            ...
            echo" <td>". $row["book_Id_code"]. " </td>
             ...
             <td> " . $row["author"]."</td> "            
              ...
              $status = $row["book_loan_status"];
           
              if($status == "AVAILABLE")
              {
                echo"<td><button id='reserveButton'  type= 'button' class='btn btn-primary btn-sm' enabled >Reserve
                Book</button><td>";
              }
              else{
                echo"<td><button id='reserveButton'  type= 'button' class='btn btn-primary btn-sm' disabled >Reserve
                Book</button><td>";
